...
class DartmouthID {
    ...
    static let instance = DartmouthID()
    
    var phone: String = "55555565555"
    var email: String = "joshuaHolme19@gmail.com"
    var website: String = "https://www.umassd.edu"
    ...
    func generateGraphics(referenceImage: ARReferenceImage, node: SCNNode) {
        ...
        // WIFI PLANE NODE
        let sceneTwo = self.createSKScene(color: #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0), image: "Dartmouth", ratio: 2/3)
        ...
        if let videoURL = Bundle.main.url(forResource: "UMass Dartmouth", withExtension: "mp4"){
